...
An intelligent system that analyzes academic indicators to identify students who may be at risk.
...
A Machine Learning project designed to analyze student academic data and predict performance.
...
A hardware + software prototype that recognizes hand gestures using flex sensors and converts them into text/speech.

**Tech Stack**

`Arduino` `Flex Sensors` `Google TTS`
